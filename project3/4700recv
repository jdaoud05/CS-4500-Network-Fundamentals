...
def checksum(data):
    # compute and return a hex digest that can be used to detect corruption
    pass
...
class Receiver:
    ...
    def validate_packet(self, msg):
                # check whether the packet's data matches its checksum field. ret True if the packet is intact, False if it has been corrupted.
        pass
